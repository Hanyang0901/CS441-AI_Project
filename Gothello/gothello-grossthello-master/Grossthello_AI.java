...
public class Grossthello_AI {
    GthClient client;
    WorkBoard_AI board = new WorkBoard_AI();
    int depth;
    
    public Grossthello_AI(GthClient client, int depth) {
		this.client = client;
		this.depth = depth;
    }
    ...
    public static void main(String args[]) throws IOException {
		...
		Grossthello_AI game = new Grossthello_AI(client, depth);
		game.play();
    }
}
